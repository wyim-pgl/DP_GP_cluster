...
parser.add_argument("-c", "--criterion", dest="criterion", type=str, default='MAP',
                    ...
                    Or, you may cluster genes post-hoc according to a criterion not implemented
""")
##############################################################################
#
...
if (args.gene_expression_matrix is None) or (args.output_path_prefix is None):
    parser.print_help()
    exit()
...
if not args.post_process:
    ...
    GS = core.gibbs_sampler(
        gene_expression_matrix, t, args.max_num_iterations, args.max_iters,
        args.optimizer, burnIn_phaseI, burnIn_phaseII, args.alpha, args.m,
        args.s, args.check_convergence, args.check_burnin_convergence,
        args.sparse_regression, args.fast, sigma_n, sigma_n2_shape, sigma_n2_rate,
